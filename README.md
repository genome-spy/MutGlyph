...
![Screenshot of a MutGlyph oncoplot of the maftools LAML example data](man/figures/oncoplot.png)

Explore the interactive version on the
[Get started](https://genomespy.app/MutGlyph/articles/MutGlyph.html) page.
