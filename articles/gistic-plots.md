...
`nonSignificantColor`. By default, the five significant cytobands with
the lowest q-values are labelled.
...
provide peak-level q-values and sample and gene counts.
